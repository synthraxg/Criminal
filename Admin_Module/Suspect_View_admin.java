...
import Officer_Module.View_sus_off;
...
public class Suspect_View_admin extends javax.swing.JFrame {

    /**
     * Creates new form Suspect_View
     */
    public Suspect_View_admin() {
        initComponents();
    }
    
    public ArrayList<View_sus_admin> userList(){
        ArrayList<View_sus_admin> userList = new ArrayList<>();
        try{
            ...
            View_sus_admin sus;
            while(rs.next()){
                sus = new View_sus_admin(rs.getInt("case_ids"), rs.getString("nameofsuspect"), rs.getString("mobile"), rs.getString("address"), rs.getString("relation"), rs.getString("date"), rs.getString("note"));
                userList.add(sus);
            }
        }
        catch(Exception e){
    ...
    public void show_sus(){
        ArrayList<View_sus_admin> suss = userList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Suspect_View_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Suspect_View_admin().setVisible(true);
            }
        });
    }
