...
import Officer_Module.History_Off;
...
public class CaseHistory_View_admin extends javax.swing.JFrame {

    /**
     * Creates new form CaseHistory
     */
    public CaseHistory_View_admin() {
        initComponents();
    }
    ...
    public ArrayList<History_Off> userList(){
        ...
        try{
            ...
            History_Off history;
            while(rs.next()){
                history = new History_Off(rs.getInt("idcase"), rs.getString("casehistory_note"), rs.getString("date"), rs.getInt("officer_idch"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaseHistory_View_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaseHistory_View_admin().setVisible(true);
            }
        });
    }
