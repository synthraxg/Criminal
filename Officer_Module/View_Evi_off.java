...
public class View_Evi_off {
    private int id_cases, idofficers, points;
    private String evidence, type, suspect_name, note, date;
    
    public View_Evi_off(int id_cases, String evidence, String type, String suspect_name, String note, int points, String date, int idofficers){
